...
#include "DNN_model.h"                          // Descomente para usar o modelo SGD

// -------------------------------------------------------------------------------------------------------------------------

const float accelerationThreshold = 3;          // Limiar de aceleração para iniciar a coleta de amostras
const int numSamples = 50;                      // Número de amostras a serem coletadas
...
constexpr int tensorArenaSize = 16 * 1024;      // Tamanho da área de memória reservada para o TensorFlow Lite.
